...
function DutyLocations({ companyId }) {
  ...
  return (
    <>
      ...
      <div className="mt-4">
        <div className={`glass-card rounded-3xl p-6 md:p-8 mb-8 transition-all duration-300 border border-slate-200/80 shadow-[0_15px_30px_-10px_rgba(15,23,42,0.08)] ${editingId ? "ring-2 ring-blue-500/20 bg-blue-50/10" : "ring-1 ring-slate-200/50 bg-white/70"
          }`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input type="text" placeholder="e.g. Sydney" value={placeName}
                onChange={(e) => { setPlaceName(e.target.value); setErrors((p) => ({ ...p, placeName: "" })); }}
                className={`w-full h-11 border px-3 rounded-xl focus:outline-none focus:ring-4 transition text-xs bg-slate-50/50 hover:bg-slate-50 focus:bg-white ${errors.placeName ? "border-red-400 focus:ring-red-500/10 focus:border-red-500" : "border-slate-200 focus:ring-emerald-500/10 focus:border-emerald-600"
                  }`} />
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input type="text" placeholder="-33.8688" value={latitude}
                  ...
                  className={`flex-1 w-full h-11 border px-3 rounded-xl focus:outline-none focus:ring-4 transition text-xs bg-slate-50/50 hover:bg-slate-50 focus:bg-white ${errors.latitude ? "border-red-400 focus:ring-red-500/10 focus:border-red-500" : "border-slate-200 focus:ring-emerald-500/10 focus:border-emerald-600"
                    }`} />
            ...
            <div>
              ...
              <input type="text" placeholder="80.2707" value={longitude}
                ...
                className={`w-full h-11 border px-3 rounded-xl focus:outline-none focus:ring-4 transition text-xs bg-slate-50/50 hover:bg-slate-50 focus:bg-white ${errors.longitude ? "border-red-400 focus:ring-red-500/10 focus:border-red-500" : "border-slate-200 focus:ring-emerald-500/10 focus:border-emerald-600"
                  }`} />
            ...
            <div>
              ...
              <input type="number" min="10" placeholder="100" value={radius}
                ...
                className={`w-full h-11 border px-3 rounded-xl focus:outline-none focus:ring-4 transition text-xs bg-slate-50/50 hover:bg-slate-50 focus:bg-white ${errors.radius ? "border-red-400 focus:ring-red-500/10 focus:border-red-500" : "border-slate-200 focus:ring-emerald-500/10 focus:border-emerald-600"
                  }`} />
          ...
          <div className="flex gap-3 mt-6 pt-5 border-t border-slate-150">
            <button onClick={saveLocation} disabled={loading}
              className={`px-5 py-2.5 rounded-xl text-white font-bold text-xs transition-all duration-300 shadow-md flex items-center gap-1.5 ${loading
