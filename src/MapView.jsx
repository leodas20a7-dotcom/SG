            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-200 ${
                  showMap ? "bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-500/10 dark:text-red-400 dark:hover:bg-red-500/20" : "bg-blue-600 text-white hover:bg-blue-700 shadow-blue-100 dark:bg-blue-500/20 dark:text-blue-300 dark:hover:bg-blue-500/30"
                }`}
              >
